...
/**
 * The `FieldError` componet renders a styled error message for a form field.
...
const FieldError = ({
  ...
  if (message) {
    return (
      <div className={cn('me-1.5 inline text-sm text-red-600', className)} data-testid={testId}>
        {message}
      </div>
    );
  } else {
